                                                                ...
                                                                <div class="col-md-6">
                                                                        <?php 
                                                                                $items = [
                                                                                        ...
                                                                                        5 => 'Баннер в карточке товара',
                                                                                        6 => 'Баннер на странице Услуги',
                                                                                        7 => 'Баннер на странице Доставка',
                                                                                        8 => 'Баннер на странице Оплата',
                                                                                        9 => 'Баннер на странице О компании',
                                                                                        10 => 'Баннер на странице Контакты',
                                                                                ];
                                                                                $params = [
