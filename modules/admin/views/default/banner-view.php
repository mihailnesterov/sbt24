                        ...
                        <div class="col-sm-7 col-md-8">
                                <div id="content-container">
                                        ...
                                        <div class="content-block">
                                                <?= Html::a('<i class="fa fa-arrow-left"></i>', 'javascript:history.go(-1)', ['class' => 'go-back-link']) ?>
                                                <header>
                                                        ...
                                                        <div class="row">
                                                                ...
                                                                <div class="col-md-6">
                                                                        ...
                                                                        <div id="banner-image-block">
                                                                                ...
                                                                                <?= Html::fileInput('input-load-image', $model->image, ['id' => 'input-load-image','class' => 'hidden1']) ?>
